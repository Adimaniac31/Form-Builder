...
let Submission = (() => {
    ...
    var Submission = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.data = (__runInitializers(this, _formId_extraInitializers), __runInitializers(this, _data_initializers, void 0));
    ...
    (() => {
        ...
        _formId_decorators = [(0, sequelize_typescript_1.ForeignKey)(() => Form_1.Form), (0, sequelize_typescript_1.Column)({
                type: sequelize_typescript_1.DataType.UUID,
                allowNull: false,
            })];
        _data_decorators = [(0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.JSON)];
